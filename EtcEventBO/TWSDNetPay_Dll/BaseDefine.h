...
#define WM_THREAD_DEVICE_ETC_EVENT_RESP					WM_APP + 14
...
#define WM_THREAD_REMOTE_CONTROL_FIRMWARE				WM_APP + 50 //add 2017-12 升级固件
#define WM_THREAD_REMOTE_UPRGADE_RESULT                 WM_APP + 51 //远程升级结果
#define WM_THREAD_LPR_IMAGEID							WM_APP + 52 //远程升级结果


#define WM_THREAD_DEVICE_CUSTOMDATA_A5FA				WM_APP + 60   //add 2018-08

#define WM_THREAD_MANAGE_INVOICE_FEE_DISPLAY			WM_APP + 72
#define WM_THREAD_MANAGE_INVOICE_PAY_RESULT_DISPLAY		WM_APP + 73
#define WM_THREAD_MANAGE_INVOICE_QRCODE_DISPLAY			WM_APP + 74
...
enum JSON_SERVER_RETURN_CODE
{
	...
	HTTP_RC_PAY_STATUS_UNKNOW           = 26    //add 2018-09 状态未知
};
...
enum SM_PROTOCOL_CONST
{
	...
	SM_PRPTOCOL_LIGHT_FALI_PSW_INPUT= 0x25,	//请输入密码
	SM_PRPTOCOL_LIGHT_FAIL_PSW_ERR	= 0x26,	//密码错误
	SM_PRPTOCOL_LIGHT_FAIL_QR_ERR1	= 0x27,	//支付码无效
	SM_PRPTOCOL_LIGHT_FAIL_QR_ERR2	= 0x28,	//支付码超时
	SM_PRPTOCOL_LIGHT_FALI_BL_ERR	= 0x29,	//余额不足
	SM_PRPTOCOL_LIGHT_FALI_NET_ERR	= 0x2A,	//网络处理超时	
	SM_PRPTOCOL_LIGHT_FALI_PL_STOP	= 0x2B,	//设备停用	
	
	SM_PRPTOCOL_LIGHT_FALI_NFC_01	= 0x2C,	//NFC,卡片不支持闪付
	SM_PRPTOCOL_LIGHT_FALI_NFC_02	= 0x2D,	//NFC,卡片未初始化	
	SM_PRPTOCOL_LIGHT_FALI_NFC_03	= 0x2E,	//NFC,银联闪付暂停服务	
};
...
enum RESPONSE_CALLER_CODE
{
	...
	RCC_AGENT_DEBIT_ERROR   = 0x0E,     //代扣失败
	RCC_AGENT_DEBIT_RISK_ERROR   = 0x0F,     //代扣失败，账户存在风险
	RCC_AGENT_DEBIT_EXCESS_ERROR  = 0x10,     //代扣失败，超过限额
...
enum PAY_CHANNEL_TYPE_CODE
{
	...
	PCTC_VIRTUALCARD = 0x07,    //add 2018-09 虚拟卡支付
	PCTC_XUANYUANTONG = 0x08,   //
	
	PCTC_WEIXIN_AGENCY	= 51,		//支付宝代扣
	PCTC_ALIIPAY_AGENCY = 52,		//微信代扣
	PCTC_BAIDU_AGENCY	= 53,		//百度代扣
	PCTC_JD_AGENCY		= 54,		//京东代扣
	PCTC_UNIPAY_AGENCY	= 55,		//银联代扣
	PCTC_ICBC_AGENCY  = 59        //工行代扣
};
...
enum UNIPAY_MODULE_STATE
{
	...
	UMS_PARA_QUERY  = 0x06              //add 2018-04
};
...
struct ETCCardData
{
    ...
    ETCCardData()
    {
        memset(this,0,sizeof(ETCCardData));
    }
};
