...
typedef bool (WINAPI* defIF_QueryVirtualCardDebit)(IN const char* szParamContext, IN const int& iParamSize, IN const int& iFormatType, OUT char* szResult);
...
public:
	...
	int AgencyQueryVirtualCardDebit(IN const char* szParamContext, IN const int& iParamSize, IN const int& iFormatType, OUT char* szResult);
//Attributes
private:
	...
	defIF_QueryVirtualCardDebit fnIF_QueryVirtualCardDebit;
};
